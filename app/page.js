...
const features = [
  {
    ...
    description:
      "Write your heart out with a beautiful editor that makes every word feel special.",
  },
  {
    icon: Sparkles,
    title: "Daily Inspiration",
    description:
      "Start each day with inspiring prompts and beautiful imagery to spark your creativity and reflection.",
  },
  {
    icon: Lock,
    title: "Your Safe Space",
    description:
      "Your thoughts deserve privacy. Everything you write stays secure and completely private.",
  },
];
    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16 overflow-x-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <p className="text-base md:text-lg lg:text-xl text-orange-800 mb-8 px-4 max-w-3xl mx-auto">
          A special place crafted just for you to capture your thoughts, 
          track your moods, and reflect on your beautiful journey.
        </p>
      ...
      <div className="space-y-24 mt-24">
        ...
        <div className="grid md:grid-cols-2 gap-12 ">
          <div className="space-y-6">
            ...
            <p className="text-lg text-orange-700">
              Express every thought, feeling, and dream with a beautiful editor made just for you:
            </p>
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                <div className="h-2 w-2 rounded-full bg-orange-400" />
                <span>Format your words beautifully</span>
              </li>
              <li className="flex items-center gap-2">
                <div className="h-2 w-2 rounded-full bg-orange-400" />
                <span>Add links to memories</span>
              </li>
            </ul>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 md:flex-row-reverse">
          <div className="space-y-6 md:order-2">
            ...
            <p className="text-lg text-orange-700">
              See your emotional journey unfold with beautiful mood analytics:
            </p>
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                <div className="h-2 w-2 rounded-full bg-orange-400" />
                <span>Visualize your mood patterns</span>
              </li>
              <li className="flex items-center gap-2">
                <div className="h-2 w-2 rounded-full bg-orange-400" />
                <span>Discover your growth over time</span>
              </li>
            </ul>
          </div>
